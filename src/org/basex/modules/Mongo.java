...
//    	return conv.convert(string(input)).item(ctx, ii);

//    	Setup s = new Setup();
//    	s.Connection("test");
//    	//s.insertCollection("", new BasicDBObject().append("name", "Anja").append("home", "unknown"));
//    	System.out.println(s.find("bias"));
    	
//    	DBCursor cursor = s.find("bias");
//    	//System.out.println(s.find("welcome", "{'name':'s'}"));
//    	
//    	//s.insertJson("welcome", "{'name':'s', 'age':30}");
...
//    	}
    	...
    	/*************** mongoClient*******************/
    	MongoDB c = new MongoDB();
    	c.connection("test");
    	System.out.println(c.find("test"));
