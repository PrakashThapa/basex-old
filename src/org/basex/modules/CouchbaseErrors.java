...
public final class CouchbaseErrors {
   ...
   * @return query exception
   */
  static QueryException unAuthorised() {
   ...
   * @return query exception
   */
  static QueryException couchbaseClientError(final Object cbClient) {
   ...
   * @return query exception
   */
  static QueryException couchbaseOperationFail(final Object type, final Object msg) {
   ...
   * @return query exception
   */
  static QueryException keysetEmpty() {
   ...
   * @return query exception
   */
  static QueryException shutdownError() {
   ...
   * @return query exception
   */
  static QueryException timeInvalid() {
