...
public final class MongoDBErrors {
   ...
   * @return query exception
   */
  static QueryException mongoExceptionError(final Object e) {
    return thrw(4, "%s", e);
  }
  /**
   ...
   * @return query exception
   */
  static QueryException mongoClientError(final Object mongoClient) {
   ...
   * @return query exception
   */
  static QueryException mongoDBError(final Object db) {
